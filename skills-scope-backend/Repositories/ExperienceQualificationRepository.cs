...
{
    public class ExperienceQualificationRepository : IExperienceQualificationRepository
    {
        private readonly string _connectionString;

        public ExperienceQualificationRepository(IConfiguration configuration)
        {
